<div class="row">
          <div class="col-md-6 mb-3 form-group">
            ...
            <input type="text" class="form-control" name="nombre" required value="<?php echo $MiembroRecuperado -> getNombre() ?>">
          ...
          <div class="col-md-6 mb-3 form-group">
            ...
            <input type="text" class="form-control" name="apellido" required value="<?php echo $MiembroRecuperado -> getApellido() ?>">
        ...
        <div class="mb-3 form-group">
          ...
          <div class="input-group">
            ...
            <select type="text" class="custom-select d-block w-100" name="plataforma" required>
              <option><?php echo $MiembroRecuperado -> getPlataforma() ?></option>
                <option>PC</option>
            ...
            <input type="text" class="form-control" name="nickname" required value="<?php echo $MiembroRecuperado -> getNickname() ?>">
        ...
        <div class="mb-3 form-group">
          <label>Email</label>
          <input type="email" class="form-control" name="email" required value="<?php echo $MiembroRecuperado -> getEmail() ?>">
          ...
          <div class="mb-3 form-group">
          <label>Ciudad</label>
          <input type="text" class="form-control" name="ciudad" required value="<?php echo $MiembroRecuperado -> getCiudad() ?>">
        ...
        <div class="row">
          <div class="col-md-3 mb-3 form-group">
            ...
            <select type="text" class="custom-select d-block w-100" name="pais" required>
                <option>
                   <?php echo $MiembroRecuperado->getPais(); ?>
                </option>
          ...
          <div class="col-md-4 mb-3 form-group">
            ...
            <select type="text" class="custom-select d-block w-100" name="estado" required>
              <option><?php echo $MiembroRecuperado -> getEstado() ?></option>
          ...
          <div class="col-md-5 mb-3 form-group">
            ...
            <input type="date" class="form-control" name="fechaNac" required value="<?php echo $MiembroRecuperado -> getFechaNac() ?>">
